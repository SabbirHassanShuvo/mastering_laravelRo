    ...
    <div class="page-header mb-4">
        ...
        <div class="ms-auto pageheader-btn">
            <div class="d-flex align-items-center gap-2">
                <a href="<?php echo e(route('backend.spotlight.export.csv')); ?>" class="btn btn-soft-success d-inline-flex align-items-center shadow-sm">
                    <i class="ri-file-excel-line me-1"></i> Export Excel/CSV
                </a>
                <a href="<?php echo e(route('backend.spotlight.export.pdf')); ?>" class="btn btn-soft-danger d-inline-flex align-items-center shadow-sm">
