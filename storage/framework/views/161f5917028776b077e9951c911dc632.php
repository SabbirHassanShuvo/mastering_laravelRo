<?php $__env->startSection('title', 'Spotlight & Boost Payments'); ?>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h3 class="fs-22 fw-black ff-secondary mb-0 text-primary"><?php echo e($stats['active_boosts']); ?></h3>
                        </div>
                        <div class="flex-shrink-0">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h3 class="fs-22 fw-black ff-secondary mb-0 text-warning"><?php echo e($stats['pending_count']); ?></h3>
                        </div>
                        <div class="flex-shrink-0">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h3 class="fs-22 fw-black ff-secondary mb-0 text-danger"><?php echo e($stats['failed_count']); ?></h3>
                        </div>
                        <div class="flex-shrink-0">
                ...
                <div class="card-body p-0" style="height: 350px; overflow-y: auto;">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $topProducts->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php 
                                    $rank = $index + 1;
                                ...
                                <tr class="top-product-row">
                                    <td class="ps-3"><span class="rank-badge <?php echo e($rankClass); ?>"><?php echo e($rank); ?></span></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="<?php echo e($img); ?>" class="top-product-img me-2 shadow-sm" style="width:32px; height:32px;">
                                            <h6 class="fs-12 mb-0 fw-semibold text-dark text-truncate" style="max-width: 100px;"><?php echo e($item->product->title); ?></h6>
                                        </div>
                                    </td>
                                    <td class="text-end pe-3">
                                        <h6 class="text-success mb-0 fw-bold fs-12">$<?php echo e(number_format($item->total_spent, 2)); ?></h6>
                                    </td>
                                </tr>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card border-0 shadow-sm">
                <div class="card-header align-items-center d-flex bg-transparent border-bottom-dashed">
                    ...
                    <a href="<?php echo e(route('backend.spotlight.cities')); ?>" class="btn btn-soft-info btn-sm fs-10">Details</a>
                </div>
                <div class="card-body p-0" style="height: 350px; overflow-y: auto;">
                    ...
                    <div class="px-3 pb-3">
                        <div class="p-2 bg-soft-info rounded border border-info border-opacity-10 text-center">
                            <h6 class="fs-12 mb-1 fw-bold text-dark"><?php echo e($cityRevenue->first()->city ?? 'None'); ?></h6>
                            <p class="text-muted mb-0 fs-11">Top City: <strong><?php echo e(number_format($cityRevenue->first()->contribution ?? 0, 1)); ?>%</strong> contribution</p>
                        </div>
                        <div class="row g-2 mt-2">
                            <div class="col-6">
                                <div class="p-2 bg-light rounded text-center">
                                    <span class="text-muted d-block fs-10">Revenue</span>
                                    <span class="fw-bold fs-12 text-dark">$<?php echo e(number_format($cityRevenue->first()->revenue ?? 0, 0)); ?></span>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="p-2 bg-light rounded text-center">
                                    <span class="text-muted d-block fs-10">Boosts</span>
                                    <span class="fw-bold fs-12 text-dark"><?php echo e($cityRevenue->first()->boost_count ?? 0); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xl-4 col-md-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-3" style="height: 350px; overflow-y: auto;">
                    <?php $__empty_1 = true; $__currentLoopData = $expiringSoon; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="expiry-alert-item d-flex align-items-center border-0 bg-transparent mb-2 p-0">
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                                <h6 class="fs-12 mb-0 text-truncate fw-bold"><?php echo e($alert->product->title); ?></h6>
                                <p class="text-muted mb-0 fs-10"><?php echo e($alert->spotlight_end_at->diffForHumans()); ?></p>
                            </div>
                            <div class="flex-shrink-0 ms-2">
                                <span class="badge bg-soft-warning text-warning fs-10"><?php echo e($alert->spotlight_end_at->format('H:i')); ?></span>
                            </div>
                        </div>
                    ...
                    <div class="ms-auto d-flex gap-1">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="<?php echo e(route('backend.spotlight.export.csv')); ?>"><i class="ri-file-text-line me-2 text-muted"></i> Export CSV</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('backend.spotlight.export.excel')); ?>"><i class="ri-file-excel-2-line me-2 text-success"></i> Export Excel</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('backend.spotlight.export.pdf')); ?>"><i class="ri-file-pdf-line me-2 text-danger"></i> Export PDF</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('backend.spotlight.export.json')); ?>"><i class="ri-braces-line me-2 text-info"></i> Export JSON</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        var table = $('#datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('backend.spotlight.index')); ?>",
            columns: [
        ...
        // --- City Revenue Chart ---
        var options = {
            series: <?php echo json_encode($cityRevenue->take(5)->pluck('revenue'), JSON_NUMERIC_CHECK); ?>,
            labels: <?php echo json_encode($cityRevenue->take(5)->pluck('city')); ?>,
        ...
        window.viewPaymentDetail = function(id) {
            let url = "<?php echo e(route('backend.spotlight.show', ':id')); ?>".replace(':id', id);
...
<?php echo $__env->make('backend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\88013\Downloads\Sabbir\mastering_laravelRo\resources\views/backend/layout/spotlight/index.blade.php ENDPATH**/ ?>