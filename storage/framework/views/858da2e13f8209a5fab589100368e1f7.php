                ...
                <div class="card-header border-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <a class="btn btn-danger add-btn" href="<?php echo e(route('backend.feature.terms.create')); ?>">
...
<?php $__env->startPush('scripts-bottom'); ?>
    <script>
        (function($) {
            $(function() {
                ...
                let table = $('.data-table').DataTable({
                    ...
                    ajax: "<?php echo e(route('backend.feature.terms.index')); ?>",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
        ...
        function statusTerm(id) {
            let url = "<?php echo e(route('backend.feature.terms.status', ':id')); ?>";
        ...
        function editTerm(id) {
            let url = "<?php echo e(route('backend.feature.terms.edit', ':id')); ?>";
...
<?php echo $__env->make('backend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\88013\Downloads\Sabbir\mastering_laravelRo\resources\views/backend/layout/terms/index.blade.php ENDPATH**/ ?>