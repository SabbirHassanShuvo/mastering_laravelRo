...
<?php $__env->startPush('scripts-bottom'); ?>
    <script>
        $(document).ready(function() {
            ...
            */
            ...
            $('#categoryForm').on('submit', function(e) {
                ...
                let url = id ? "<?php echo e(route('backend.feature.category.update', ':id')); ?>".replace(':id', id) : "<?php echo e(route('backend.feature.category.store')); ?>";
        ...
        function edit(id) {
            let url = "<?php echo e(route('backend.feature.category.edit', ':id')); ?>".replace(':id', id);
        ...
        function showStatusChangeAlert(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.post("<?php echo e(route('backend.feature.category.status', ':id')); ?>".replace(':id', id), { _token: "<?php echo e(csrf_token()); ?>" }, function(response) {
                        $('#datatable').DataTable().ajax.reload(null, false);
                        toastr.success(response.message);
                    });
                }
        ...
        function showDeleteConfirm(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('backend.feature.category.destroy', ':id')); ?>".replace(':id', id),
...
<?php echo $__env->make('backend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\88013\Herd\mastering_laravelRo\resources\views/backend/layout/categories/index.blade.php ENDPATH**/ ?>