                    ...
                    <form id="userForm">
                        ...
                        <div class="mb-4">
                            <label for="password" class="form-label">Password <span class="text-danger"
                                    id="password_required_star">*</span></label>
                            ...
                            <small class="text-muted fs-11 mt-1 edit-note d-none">Leave blank to keep current
                                password.</small>
                        </div>
    ...
    <script>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            let roleLabel = (row.role === 'admin' || row.is_admin_user == 1) ?
                                'Administrator' : 'User';
                            let verifiedBadge = row.is_verified ? 
                                '<span class="badge badge-soft-success badge-border ms-1"><i class="ri-checkbox-circle-line align-middle"></i> Verified</span>' : 
                                '';
                            return `<div class="d-flex align-items-center">
                                        <div class="user-avatar-circle me-3">${initial}</div>
                                        <div>
                                            <h6 class="mb-0 fw-bold text-dark">${data} ${verifiedBadge}</h6>
        ...
        function toggleVerify(id) {
            Swal.fire({
                ...
                text: 'Are you sure you want to toggle the verification status for this user?',
                icon: 'question',
                showCancelButton: true,
