        ...
        <div class="col-xxl-9">
            <div class="card shadow-lg border-0">
                <div class="card-header bg-primary p-3 d-flex align-items-center">
                    <h4 class="card-title mb-0 grow text-white">
                ...
                <div class="card-body p-0">
                    <div class="row g-0">
                        ...
                        <div class="col-md-3 border-end">
                            <div class="nav flex-column nav-pills nav-pills-custom p-3" id="settingsTabs" role="tablist"
                                ...
                                <button class="nav-link mb-2 text-start p-3" id="sslcommerz-tab" data-bs-toggle="tab"
                                    ...
                                    data-uri="<?php echo e(route('backend.settings.payments.sslcommerz.update')); ?>">
                                ...
                                <button class="nav-link text-start p-3" id="other-tab" data-bs-toggle="tab"
                                    ...
                                    data-uri="<?php echo e(route('backend.settings.payments.general.update')); ?>">
                            ...
                            <div class="tab-content" id="settingsTabsContent">
                                ...
                                <div class="tab-pane fade show active" id="stripe" role="tabpanel">
                                    <div class="mb-4">
                                        ...
                                        <p class="text-muted fs-13">Configure your Stripe API keys for processing credit
                                            card payments.</p>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="sslcommerz" role="tabpanel">
                                    ...
                                    <form class="ajax-form">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="sslc_store_id" class="form-control"
                                                value="<?php echo e(env('SSLCZ_STORE_ID')); ?>" placeholder="Enter Store ID">
                                        </div>
                                        <div class="mb-4">
                                            <label class="form-label fw-bold">Store Password</label>
                                            <input type="password" name="sslc_store_password" class="form-control"
                                                value="<?php echo e(env('SSLCZ_STORE_PASSWORD')); ?>"
