<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        <!-- Dark Logo-->
        <a href="<?php echo e(route('backend.dashboard.index')); ?>" class="logo logo-dark">
            <span class="logo-sm">
        ...
        <!-- Light Logo-->
        <a href="<?php echo e(route('backend.dashboard.index')); ?>" class="logo logo-light">
            <span class="logo-sm">
                <img src="<?php echo e($settings->mini_logo ? asset($settings->mini_logo) : asset('assets/images/logo-sm.png')); ?>"
                    alt="" height="22">
            </span>
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link  <?php echo e(getPageStatus('backend.dashboard.*', 'collapsed active')); ?>"
                        href="<?php echo e(route('backend.dashboard.index')); ?>" role="button">
                        <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Dashboards</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link menu-link <?php echo e(request()->routeIs('backend.system-user.*') ? 'active' : ''); ?>"
                        href="<?php echo e(route('backend.system-user.index')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link <?php echo e(request()->routeIs('backend.messaging.*') ? 'active' : ''); ?>"
                        href="#sidebarMessaging" data-bs-toggle="collapse" role="button" aria-expanded="false"
                        aria-controls="sidebarMessaging">
                        <i class="ri-chat-3-line"></i>
                        <span>Messaging</span>
                    </a>
                    <div class="collapse menu-dropdown <?php echo e(request()->routeIs('backend.messaging.*') ? 'show' : ''); ?>"
                        id="sidebarMessaging">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('backend.messaging.conversations')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('backend.messaging.conversations')); ?>">Conversations</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('backend.messaging.pickups')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('backend.messaging.pickups')); ?>">Pickup
                                    Requests</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('backend.messaging.analytics')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('backend.messaging.analytics')); ?>">Analytics</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link <?php echo e(getPageStatus('backend.page.*', 'collapsed active')); ?>"
                        href="#sidebarPages" data-bs-toggle="collapse" role="button" aria-expanded="false"
                        aria-controls="sidebarPages">
                        <i class="ri-pages-line"></i> <span data-key="t-pages">Pages</span>
                    </a>
                    <div class="collapse menu-dropdown <?php echo e(getPageStatus('backend.page.*', 'show')); ?>"
                        id="sidebarPages">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('backend.page.index')); ?>"
                                    class="nav-link <?php echo e(getPageStatus('backend.page.*')); ?>" data-key="t-starter"> All
                                </a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown <?php echo e(getPageStatus('backend.settings.*', 'show')); ?>"
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('backend.settings.payments.stripe.index')); ?>"
                                    class="nav-link <?php echo e(getPageStatus('backend.settings.payments.*')); ?>"
...
<?php /**PATH C:\Users\88013\Herd\mastering_laravelRo\resources\views/backend/partials/sidebar.blade.php ENDPATH**/ ?>