<?php $__env->startSection('title', 'Garage Sales Management'); ?>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="fs-24 fw-black text-primary mb-0"><?php echo e($stats['total']); ?></h4>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="fs-24 fw-black text-success mb-0"><?php echo e($stats['live']); ?></h4>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="fs-24 fw-black text-info mb-0"><?php echo e($stats['upcoming']); ?></h4>
                        </div>
                        <div class="flex-shrink-0">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="fs-24 fw-black text-warning mb-0"><?php echo e($stats['expired']); ?></h4>
                        </div>
                        <div class="flex-shrink-0">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header py-3">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <a href="<?php echo e(route('backend.garage.create')); ?>" class="btn btn-primary btn-sm">
    ...
    <script>
        $(document).ready(function() {
            ...
            window.viewGarageSale = function(id) {
                let url = '<?php echo e(route('backend.garage.show', ':id')); ?>'.replace(':id', id);
            ...
            window.showDeleteConfirm = function(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '<?php echo e(route('backend.garage.destroy', ':id')); ?>'.replace(':id', id),
                            type: 'DELETE',
