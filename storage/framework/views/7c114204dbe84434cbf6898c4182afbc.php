<?php $__env->startSection('title', 'Garage Sales Inventory'); ?>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h3 class="fs-22 fw-black ff-secondary mb-0 text-success"><?php echo e(number_format($stats['total'])); ?>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h3 class="fs-22 fw-black ff-secondary mb-0 text-primary"><?php echo e(number_format($stats['active'])); ?>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h3 class="fs-22 fw-black ff-secondary mb-0 text-warning">
                                $<?php echo e(number_format($stats['total_revenue'], 2)); ?></h3>
                        </div>
                        <div class="flex-shrink-0">
                            <div
                    ...
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h3 class="fs-22 fw-black ff-secondary mb-0 text-danger">
                                $<?php echo e(number_format($stats['pending_revenue'], 2)); ?></h3>
                        </div>
                        <div class="flex-shrink-0">
                            <div
                ...
                <div class="card-body p-0" style="height: 350px;">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $topSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $rank = $index + 1;
                                    ...
                                    <tr class="top-sale-row">
                                        <td class="ps-3"><span
                                                class="rank-badge <?php echo e($rankClass); ?>"><?php echo e($rank); ?></span></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <h6 class="fs-12 mb-0 fw-semibold text-dark text-truncate"
                                                    style="max-width: 150px;"><?php echo e($sale->event_title); ?></h6>
                                            </div>
                                        </td>
                                        <td class="text-end pe-3">
                                            <h6 class="text-success mb-0 fw-bold fs-12">
                                                $<?php echo e(number_format($sale->total_fee, 2)); ?></h6>
                                        </td>
                                    </tr>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card border-0 shadow-sm">
                <div class="card-header align-items-center d-flex bg-transparent border-bottom-dashed">
                    ...
                    <div class="flex-shrink-0">
                        <a href="<?php echo e(route('backend.garage.analytics')); ?>" class="btn btn-soft-info btn-sm fs-11 px-2 py-0"
                ...
                <div class="card-body p-3 d-flex flex-column justify-content-center" style="height: 350px;">
                    <?php if(isset($topCity) && $topCity): ?>
                        <div class="top-city-banner text-center py-3 px-2 mb-4"
                            ...
                            <h5 class="mb-1 fw-bold text-dark"><?php echo e($topCity->pickup_location); ?></h5>
                            <p class="text-muted mb-0 fs-12">Top City: <span
                                    class="fw-bold text-primary"><?php echo e(number_format($topCity->contribution, 1)); ?>%</span>
                                contribution</p>
                        </div>
                        ...
                        <div class="row g-2">
                            <div class="col-4">
                                <div class="p-2 text-center rounded bg-light bg-opacity-50 border border-dashed">
                                    ...
                                    <h5 class="mb-0 fw-bold text-dark">$<?php echo e(number_format($topCity->revenue, 0)); ?></h5>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="p-2 text-center rounded bg-light bg-opacity-50 border border-dashed">
                                    <p class="text-muted mb-0 fs-10 text-uppercase fw-medium">Users</p>
                                    <h5 class="mb-0 fw-bold text-dark"><?php echo e($topCity->user_count); ?></h5>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="p-2 text-center rounded bg-light bg-opacity-50 border border-dashed">
                                    <p class="text-muted mb-0 fs-10 text-uppercase fw-medium">Posts</p>
                                    <h5 class="mb-0 fw-bold text-dark"><?php echo e($topCity->post_count); ?></h5>
                                </div>
                            </div>
                        </div>
                    <?php else: ?>
        ...
        <div class="col-xl-4 col-md-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-3" style="height: 350px; overflow-y: auto;">
                    <?php $__empty_1 = true; $__currentLoopData = $expiringSoon; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="expiry-alert-item d-flex align-items-center border-0 bg-transparent mb-2 p-0">
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                                <h6 class="fs-12 mb-0 text-truncate fw-bold"><?php echo e($sale->event_title); ?></h6>
                                <p class="text-muted mb-0 fs-10">
                                    <?php echo e(\Carbon\Carbon::parse($sale->sale_end_date)->diffForHumans()); ?></p>
                            </div>
                            <div class="flex-shrink-0 ms-2">
                                <span
                                    class="badge bg-soft-warning text-warning fs-10"><?php echo e(\Carbon\Carbon::parse($sale->sale_end_date)->format('H:i')); ?></span>
                            </div>
                        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header border-bottom d-flex align-items-center bg-transparent">
                    ...
                    <div class="flex-shrink-0 d-flex gap-2">
                        <a href="<?php echo e(route('backend.garage.create')); ?>"
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow">
                                <li><a class="dropdown-item fs-12" href="<?php echo e(route('backend.garage.export.csv')); ?>"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('backend.garage.index')); ?>",
                    data: function(d) {
            ...
            window.viewGarageSale = function(id) {
                $.get("<?php echo e(url('backend/garage-sales')); ?>/" + id, function(res) {
                    if (res.success) {
                        const s = res.data;
                            ...
                            s.items.forEach((item, idx) => {
                                ...
                                if (item.images && item.images.length > 0) {
                                    item.images.forEach(img => {
                                        let imgUrl = "<?php echo e(asset('storage')); ?>/" + img.photo;
                                    ...
                                    slides = `<div class="swiper-slide"><img src="<?php echo e(asset('assets/images/no-image.png')); ?>" class="rounded border" style="width:100%; height:280px; object-fit:contain; background:#f9f9f9;"></div>`;
                                }
            ...
            window.showDeleteConfirm = function(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo e(url('backend/garage-sales')); ?>/" + id,
                            type: 'DELETE',
                            data: {
            ...
            window.archiveSale = function(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.post("<?php echo e(url('backend/garage-sales')); ?>/" + id + "/archive", {
                            _token: "<?php echo e(csrf_token()); ?>"
                        }, function(res) {
                            table.ajax.reload();
            ...
            window.exportData = function(format) {
                let url = "";
                if (format === 'csv') url = "<?php echo e(route('backend.garage.export.csv')); ?>";
                else if (format === 'excel') url = "<?php echo e(route('backend.garage.export.excel')); ?>";
                else if (format === 'pdf') url = "<?php echo e(route('backend.garage.export.pdf')); ?>";
...
<?php echo $__env->make('backend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\88013\Downloads\Sabbir\mastering_laravelRo\resources\views/backend/layout/garage_sales/index.blade.php ENDPATH**/ ?>