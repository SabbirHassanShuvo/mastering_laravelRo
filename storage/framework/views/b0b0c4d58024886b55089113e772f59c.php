        ...
        <?php $__currentLoopData = $statMap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $cfg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-xl-3 col-md-6 mb-3 mb-xl-0">
                <div class="card border-0 shadow-sm"
                    style="border-left: 4px solid var(--vz-<?php echo e($cfg['color']); ?>) !important;">
                    <div class="card-body d-flex align-items-center gap-3">
                        <div
                            class="avatar-sm bg-soft-<?php echo e($cfg['color']); ?> rounded-circle d-flex align-items-center justify-content-center">
                        ...
                        <table class="table table-hover align-middle mb-0" id="pickupTable">
                            ...
                            <tbody id="pickupBody">
                                <?php $__currentLoopData = $pickups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pickup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <tr class="row-hover border-bottom" data-status="<?php echo e($pickup->status); ?>"
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    <p class="mb-0 fw-semibold fs-13 text-truncate"
                                                        style="max-width:130px;"><?php echo e($pickup->product->title ?? 'N/A'); ?></p>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    <p class="mb-0 fw-semibold fs-13">
                                                        <?php echo e($pickup->requester->name ?? 'N/A'); ?></p>
                                        ...
                                        <td>
                                            <p class="mb-0 fw-semibold fs-13"><i
                                                    class="ri-calendar-line me-1 text-primary"></i><?php echo e($pickup->pickup_date ?? 'N/A'); ?>

                                            </p>
                                            <small class="text-muted"><i
                                                    class="ri-time-line me-1"></i><?php echo e($pickup->pickup_time ?? '—'); ?></small>
                                        </td>
                                        <td>
                                            <span class="fs-12 text-muted" title="<?php echo e($pickup->location); ?>">
                                                <i
                                                    class="ri-map-pin-line me-1 text-danger"></i><?php echo e(Str::limit($pickup->location ?? '—', 28)); ?>
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-soft-success btn-sm rounded-pill px-3"
                                                ...
                                                data-status="<?php echo e($pickup->status); ?>" data-badge-class="<?php echo e($badgeClass); ?>"
