                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('backend.messaging.pickups')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('backend.messaging.pickups')); ?>">Pickup Requests</a>
                            </li>
                            <li class="nav-item">
...
<?php /**PATH C:\Users\88013\Downloads\Sabbir\mastering_laravelRo\resources\views/backend/partials/sidebar.blade.php ENDPATH**/ ?>