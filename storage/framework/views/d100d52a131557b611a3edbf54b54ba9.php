                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control" id="firstnameInput"
                                                placeholder="Enter your firstname" value='<?php echo e(old('name',$user->name)); ?>'>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="phone" name="phone" class="form-control" 
                                                placeholder="Enter your phone number" value='<?php echo e(old('phone',$profile->phone)); ?>'>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="address" class="form-control" id="emailInput"
                                                placeholder="Dhaka, Bangladesh" value='<?php echo e(old('address',$profile->address)); ?>'>
                                        </div>
                                    </div>
