    ...
    <ul class="nav nav-tabs" id="settingsTabs" role="tablist">
        <li class="nav-item">
            <button class="nav-link active" id="stripe-tab" data-bs-toggle="tab"
                    ...
                    data-uri="<?php echo e(route('backend.settings.payments.stripe.update')); ?>">Stripe</button>
        </li>
        <li class="nav-item">
            <button class="nav-link" id="mail-tab" data-bs-toggle="tab"
                    data-bs-target="#mail" type="button" role="tab"
                    data-uri="<?php echo e(route('backend.settings.payments.stripe.test')); ?>">SSL COMMERZ</button>
        </li>
        <li class="nav-item">
            <button class="nav-link" id="other-tab" data-bs-toggle="tab"
                    data-bs-target="#other" type="button" role="tab"
                    data-uri="<?php echo e(route('backend.settings.payments.stripe.test')); ?>">Other</button>
        </li>
    </ul>
            ...
            <form class="ajax-form">
                <div class="mb-3">
                    ...
                    <input type="text" name="mail_host" class="form-control"
                           value="<?php echo e(env('MAIL_HOST')); ?>" placeholder="Enter Mail Host">
                </div>
                <div class="mb-3">
                    <label class="form-label">Mail Username</label>
                    <input type="text" name="mail_username" class="form-control"
                           value="<?php echo e(env('MAIL_USERNAME')); ?>" placeholder="Enter Mail Username">
                </div>
            ...
            <form class="ajax-form">
                <div class="mb-3">
                    ...
                    <input type="text" name="app_name" class="form-control"
                           value="<?php echo e(config('app.name')); ?>" placeholder="Enter App Name">
                </div>
                <div class="mb-3">
                    <label class="form-label">App URL</label>
                    <input type="text" name="app_url" class="form-control"
                           value="<?php echo e(config('app.url')); ?>" placeholder="Enter App URL">
                </div>
