...
@section('title', 'Garage Sales Analytics')
    ...
    <div class="page-header mb-4">
        ...
        <div class="ms-auto pageheader-btn">
            <div class="d-flex justify-content-between align-items-center gap-2">
                ...
                <a href="{{ route('backend.garage.index') }}" class="btn btn-primary d-inline-flex align-items-center">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="text-white mb-0 fw-bold">${{ number_format($totalRevenue, 2) }}</h2>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="text-white mb-0 fw-bold">{{ number_format($totalSales) }}</h2>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                            <span class="avatar-title bg-white bg-opacity-10 rounded fs-24">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card stat-card card-animate bg-info text-white shadow-info">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <p class="text-white-50 text-uppercase fw-semibold mb-1 fs-12">Top City: {{ $topCity->city ?? 'N/A' }}</p>
                            <h2 class="text-white mb-0 fw-bold">${{ number_format($topCity->total_revenue ?? 0, 2) }}</h2>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                            <span class="avatar-title bg-white bg-opacity-10 rounded fs-24">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="text-white mb-0 fw-bold">{{ number_format($totalUsers) }}</h2>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                            <span class="avatar-title bg-white bg-opacity-10 rounded fs-24">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="{{ route('backend.garage.export.csv') }}">CSV Report</a>
                                </li>
                                <li><a class="dropdown-item" href="{{ route('backend.garage.export.excel') }}">Excel
                                        Spreadsheet</a></li>
                                <li><a class="dropdown-item" href="{{ route('backend.garage.export.pdf') }}">PDF
                                        Document</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="analyticsTable" class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                @foreach ($cityAnalytics as $index => $item)
                                    <tr class="city-row">
                                        <td>
                                            <div class="d-flex align-items-center">
                                        ...
                                        <td>
                                            <h6 class="fs-14 mb-0 fw-bold text-dark">{{ $item->city }}</h6>
                                            <span class="text-muted fs-11">Primary Region</span>
                                        </td>
                                        <td class="text-center">
                                            <span
                                                class="badge badge-soft-warning">{{ number_format($item->user_count) }}</span>
                                        </td>
                                        <td class="text-center">
                                            <span
                                                class="badge badge-soft-info">{{ number_format($item->post_count) }}</span>
                                        </td>
                                        <td class="text-end fw-bold text-dark">
                                            ${{ number_format($item->total_revenue, 2) }}
                                        </td>
                                        <td class="text-end text-primary fw-medium">
                                            ${{ number_format($item->revenue_per_post, 2) }}
                                        </td>
                                        <td class="text-end">
                                            <div
                                                class="d-flex align-items-center justify-content-end gap-2 text-success fw-bold">
                                                <span>{{ number_format($item->rev_contribution, 1) }}%</span>
...
@push('scripts-bottom')
    ...
    <script>
        $(document).ready(function() {
            const cityData = {!! json_encode($cityAnalytics) !!};
