...
@section('content')
    ...
    <form id="productForm" action="{{ route('backend.products.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" 
                                       placeholder="e.g. Vintage Camera" value="{{ old('title') }}" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="product_type" id="product_type" class="form-select @error('product_type') is-invalid @enderror" required>
                                    <option value="paid" {{ old('product_type') == 'paid' ? 'selected' : '' }}>Paid</option>
                                    <option value="free" {{ old('product_type') == 'free' ? 'selected' : '' }}>Free Item</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="condition_status" class="form-select">
                                    <option value="new" {{ old('condition_status') == 'new' ? 'selected' : '' }}>Brand New</option>
                                    <option value="like-new" {{ old('condition_status') == 'like-new' ? 'selected' : '' }}>Like New</option>
                                    <option value="good" {{ old('condition_status') == 'good' ? 'selected' : '' }}>Good Condition</option>
                                    <option value="fair" {{ old('condition_status') == 'fair' ? 'selected' : '' }}>Fair / Used</option>
                                </select>
                            </div>
                ...
                <div class="card shadow-sm border-0 mt-4">
                    <div class="card-body p-4 text-center">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('backend.products.index') }}" class="btn btn-soft-secondary">
                                Cancel
                            </a>
                        </div>
                    </div>
