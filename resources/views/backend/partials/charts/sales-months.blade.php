        ...
        <div class="card">
            ...
            <div class="card-header p-0 border-0 bg-soft-light">
                <div class="row g-0 text-center">
                    <div class="col-6">
                        <div class="p-3 border border-dashed border-start-0">
                            <h5 class="mb-1"><span class="counter-value" data-target="{{ $totalOrders }}">0</span></h5>
                    ...
                    <div class="col-6">
                        <div class="p-3 border border-dashed border-start-0">
                            <h5 class="mb-1">$<span class="counter-value" data-target="{{ round($totalRevenue, 2) }}">0</span></h5>
             ...
             <div class="card-body">
                <div class="table-responsive table-card">
                    <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            @forelse($topGarageCities as $city)
                            <tr>
                                <td>
                                ...
                                <td>
                                    <span class="badge badge-soft-success fs-12">{{ $city->total }} Events</span>
                                </td>
                            </tr>
                            @empty
